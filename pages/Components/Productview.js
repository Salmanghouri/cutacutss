...
const Productview = () => {
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <Image  className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="/4.jpg" width={500} height={500}/>
       
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 className="text-sm title-font text-gray-500 tracking-widest">cutacut</h2>
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Cutacut Kitchen Scissors Stainless Steel Sharp Blades with TRP Grip</h1>
          ...
          <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
            <div className="flex">
             ...
             <button className="border-2 border-gray-300 ml-1 bg-[#E72526] rounded-full w-6 h-6 focus:outline-none" />
            </div>
            <div className="flex ml-6 items-center">
              <span className="mr-3">Size:</span>
              <div className="relative">
              <p className="text-md font-bold">20 x 9 x 1 centimetres</p>
              </div>
            </div>
            <div className="flex ml-6 items-center">
              <span className="mr-3">Material:</span>
              <div className="relative">
              <p className="text-md font-bold">Stainless Steel</p>
              </div>
            </div>
          </div>
          <div className="flex">
            <span className="title-font font-medium text-xl text-red-900">$ Currently unavailable.</span>
            <Link href="https://www.amazon.co.uk/dp/B09CDVYZVP?ref=myi_title_dp"><a  className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Buy Now</a></Link>
  ...
  <div className="container px-2 py-1 mx-auto lg:pt-1 lg:px-32">
    <div className="flex flex-wrap -m-1 md:-m-2">
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
          <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/5.jpg" width={400} height={400}/>
          
        </div>
      </div>
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
        <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/2.jpg" width={400} height={400}/>
        </div>
      </div>
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
        <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/6.jpg" width={400} height={400}/>
        </div>
      </div>
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
        <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/1.jpg" width={400} height={400}/>
        </div>
      </div>
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
        <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/3.jpg" width={400} height={400}/>
        </div>
      </div>
      <div className="flex flex-wrap w-1/3">
        <div className="w-full p-1 md:p-2">
        <Image  className="block object-cover object-center w-full h-full rounded-lg"  src="/7.jpg" width={400} height={400}/>
        </div>
      </div>
    </div>
  </div>
...
<section className="overflow-hidden bg-gray-100 text-gray-500 ">
